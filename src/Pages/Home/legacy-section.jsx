...
const sketch = "/general/sketch_Two.png";
const iconOne = "/icons/icon1.webp";
const iconTwo = "/icons/icon2.webp";
const iconThree = "/icons/icon3.webp";
const iconFour = "/icons/icon4.webp";
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center justify-center mb-2">
              <img src={iconOne} alt="Career icon" className="w-10 h-10" />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center justify-center mb-2">
              <img src={iconTwo} alt="Alumni icon" className="w-10 h-10" />
            </div>
            <p className="text-xl font-bold text-[#00b8d4]">
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center justify-center mb-2">
              <img src={iconThree} alt="Faculty icon" className="w-10 h-10" />
            </div>
            <p className="text-xl font-bold text-[#00b8d4]">
              {counters.faculty}+
            </p>
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center justify-center mb-2">
              <img src={iconFour} alt="Students icon" className="w-10 h-10" />
            </div>
            <p className="text-xl font-bold text-[#00b8d4]">
